 ...
 * Tabs: Process Map, Capability×Process, Process×App, Process×Org, Dependencies,
...
export default function BpmReportsContent() {
  ...
  return (
    <Box sx={{ p: { xs: 2, md: 3 } }}>
      ...
      {tab === 6 && <ElementItComponentMap onOpenCard={setSidePanelCardId} />}
      {tab === 7 && <ElementDataObjectMap onOpenCard={setSidePanelCardId} />}
      <CardDetailSidePanel
