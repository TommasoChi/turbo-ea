...
### Eccezione SDK 1.4 / frontend SDK 1.18 del 2026-07-30

Autorizzata e implementata in modo additivo per audit extension read-only, controlli permesso request-scoped e permessi frontend read-only. Verificata esclusivamente con test SDK mirati; nessuna build o deploy del core.
