...
**报表**选项卡还会将单个 BPMN 步骤与 EA 全景进行交叉引用：

- **元素-应用映射** — 哪些 BPMN 元素使用哪些应用，按应用分组
- **元素-IT 组件映射** — 哪些 BPMN 元素使用哪些 IT 组件，按 IT 组件分组
- **元素-数据对象映射** — 哪些 BPMN 元素使用哪些数据对象，按数据对象分组

每一行都链接回所属流程，并显示元素类型和泳道，因此可以准确看到应用、IT 组件或数据对象在流程中的使用位置。
