...
Вкладка **Отчёты** также сопоставляет отдельные шаги BPMN с ландшафтом EA:

- **Карта «Элемент — Приложение»** — какие элементы BPMN используют какие приложения, с группировкой по приложению
- **Карта «Элемент — ИТ-компонент»** — какие элементы BPMN используют какие ИТ-компоненты, с группировкой по ИТ-компоненту
- **Карта «Элемент — Объект данных»** — какие элементы BPMN используют какие объекты данных, с группировкой по объекту данных

Каждая строка ссылается на свой процесс и показывает тип элемента и дорожку, поэтому видно, где именно приложение, ИТ-компонент или объект данных используется внутри потока.
