...
تربط علامة التبويب **التقارير** أيضًا خطوات BPMN الفردية بمشهد بنية المؤسسة:

- **خريطة العنصر - التطبيق** — أي عناصر BPMN تستخدم أي تطبيقات، مجمَّعة حسب التطبيق
- **خريطة العنصر - مكوّن تقنية المعلومات** — أي عناصر BPMN تستخدم أي مكوّنات تقنية معلومات، مجمَّعة حسب مكوّن تقنية المعلومات
- **خريطة العنصر - كائن البيانات** — أي عناصر BPMN تستخدم أي كائنات بيانات، مجمَّعة حسب كائن البيانات

يرتبط كل صف بعمليته ويعرض نوع العنصر والمسار، بحيث يتضح بدقة أين يُستخدم تطبيق أو مكوّن تقنية معلومات أو كائن بيانات داخل التدفق.
